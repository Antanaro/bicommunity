          ...
          <div className="flex flex-wrap items-center gap-2 self-start">
            {canCreatePoll && (
              <button
                ...
                className="px-2 py-1.5 sm:py-1 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition text-xs sm:text-sm min-h-[36px] sm:min-h-0"
            ...
            {canEditTopic && !isEditingTopic && (
              <button
                ...
                className="px-2 py-1.5 sm:py-1 rounded border border-blue-300 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition text-xs sm:text-sm min-h-[36px] sm:min-h-0"
            ...
            {isAdmin && (
              <button
                ...
                className="px-2 py-1.5 sm:py-1 rounded border border-red-300 dark:border-red-600 bg-white dark:bg-gray-700 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 transition text-xs sm:text-sm min-h-[36px] sm:min-h-0"
                title="Удалить тему"
              >
                🗑️ Удалить
              </button>
                ...
                {canEditPoll && (
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <button
                      ...
                      className="px-2 py-1.5 rounded border border-blue-300 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition text-xs sm:text-sm"
                    >
                      ✏️ Редактировать
                    </button>
                    <button
                      ...
                      className="px-2 py-1.5 rounded border border-red-300 dark:border-red-600 bg-white dark:bg-gray-700 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 transition text-xs sm:text-sm disabled:opacity-50"
                    >
